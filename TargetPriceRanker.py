...
def get_naver_target_price_html(code: str) -> float:
    """
    네이버 금융 HTML에서 목표주가 가져오기
    - 구조 D: <th>투자의견|목표주가</th> + <td> ... <em>투자의견점수</em> ... <em>목표주가</em>
    - 구조 A: <th>목표주가</th> + <td><em>437,500</em></td>
    - 구조 B: <th>목표주가</th> + <td><span class="blind">437,500</span></td>
    - 구조 C: <dt>목표주가</dt> + <dd><em>...</em> 또는 <span class="blind">...</span>
    """
...
########################################################
# Data Manager (네이버 목표가 캐시 + 멀티스레드 수집)
########################################################
